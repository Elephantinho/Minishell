...
/*   Updated: 2025/05/27 20:28:57 by ade-ross         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**built_in_or_execute(char ***env, t_token **arr_of_lists, t_token **tokens, int *exit_code);
...
char	**create_matrix_and_free_list(t_token **tokens, \
								t_token **first, char ***arr_of_matrx);
...
//execute_no_pipe_h
void	init_built_in_or_exec_no_pipes(char ***env, t_token **token_list, int *exit_code, t_exec_no_pipes *st);
