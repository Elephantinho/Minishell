...
/*   Updated: 2025/05/30 22:32:21 by ade-ross         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_redirexctions
{
	t_token	**tokens;
	int		*heredoc_done;
	int		*exit_code;
...
//cd
void	ft_cd_pars(char **args, char ***envp, int *exit_code, \
											int is_inside_pipe);
void	ft_cd_null_path(char ***envp, int *exit_code, \
									int is_inside_pipe);
...
//create_matrix
char	**create_matrix_free_lst(t_token **tokens, \
...
void	sigint_handler_third(int sig);
