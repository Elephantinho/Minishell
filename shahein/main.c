...
/*   Updated: 2025/05/12 19:06:29 by ade-ross         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	clear_history();
	free_env(env);
	exit(exit_code);// qua invece della variabile exit code mi sa che va preso exit code da env o forse no
	return (0); // da levare(?)
}
